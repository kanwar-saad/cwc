...
public class LazyAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //TextView textIcon = (TextView)vi.findViewById(R.id.textIcon); // title
        ...
        //int index = ((int)((char)file.get(MainActivity.KEY_FILENAME).charAt(0) - 'A') % 9) + 1 ;
        ...
        //String fileExt = String.valueOf(file.get(MainActivity.KEY_FILENAME).charAt(0)).toUpperCase();
        //Log.d(TAG, "File Ext = " + fileExt);
        int index = ((int)((char)ch.charAt(0) - 'A') % 9) + 1 ;
        if (index<1){
        	index = 0 - index;
        }
        textIcon.setText(fileExt);
        //RotateAnimation rotate= (RotateAnimation)AnimationUtils.loadAnimation(activity, R.layout.rotate);
        //textIcon.setAnimation(rotate);
...
//	    		adb.setTitle("SubList Item Clicked");
//	    		adb.setMessage("Selected Item is = " + getItem(pos));
//	    		//adb.setMessage("Selected Item is = " + "Nil");
//	    	    
